...
export function CodingPortfolio () {
    return (
        <section className="portf-section" id="portf-code">
            ...
            {/* Code Row 1 */}
            <section className="portf-row">
                {/* Press on Nails Project */}
                <div className="project-container">
                    <a className="portf-proj-link portf-proj-img" href="https://dazzlingnails.netlify.app/"
                        target="_blank">
                    ...
                    <div className="portf-text">
                        ...
                        <ul className="project-link-list">
                            <li>
                                <a className="portf-proj-link" href="https://dazzlingnails.netlify.app/"
                                    target="_blank">Host Link
                                </a>
                            </li>
                            <a className="portf-proj-link" href="#" target="_blank">Source Code</a>
                        </ul>
                ...
                {/* Pairs Game */}
                <div className="project-container">
                    <a className="portf-proj-link portf-proj-img" 
            ...
            <section className="portf-row">
                ...
                <div className="project-container">
                    <a className="portf-proj-link portf-proj-img" href="https://nkpe.github.io/Climbing-Quiz/"
                        target="_blank">
                    ...
                    <div className="portf-text">
                        ...
                        <a className="portf-proj-link" href="https://nkpe.github.io/Climbing-Quiz/" target="_blank">Host
                            Link</a>
                        <a className="portf-proj-link" href="https://github.com/nkpe/Climbing-Quiz"
                ...
                <div className="project-container">
                    <a className="portf-proj-link portf-proj-img" href="#" target="_blank">
                    ...
                    <div className="portf-text">
                        ...
                        <a className="portf-proj-link" href="https://github.com/lucky-eight/laptop-library"
                            target="_blank">Source Code
                        </a>
                    </div>
                </div>
